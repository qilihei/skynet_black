    ...
    execute: function () {
      ...
      _export("GameDataManager", GameDataManager = (_dec = ccclass('GameDataManager'), _dec(_class = (_class2 = class GameDataManager {
        ...
        removeItemFromInventory(slot) {
          var index = this.inventory.findIndex(item => item.slot === slot);
        ...
        updateInventoryItem(slot, quantity) {
          var item = this.inventory.find(item => item.slot === slot);
        ...
        loadFromLocal() {
          try {
            var playerDataStr = localStorage.getItem('player_data');
            ...
            var farmDataStr = localStorage.getItem('farm_data');
            ...
            var inventoryDataStr = localStorage.getItem('inventory_data');
